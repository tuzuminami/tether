...
import type { CompiledBundle, CompileOptions, JsonValue, PersonaVersion } from "./types.js";
import { validatePluginRefs } from "./validate.js";

export function compilePersonaVersion(version: PersonaVersion, options: CompileOptions): CompiledBundle {
  ...
  } satisfies Omit<CompiledBundle, "contentHash">;

  const contentHash = sha256Hex(canonicalJson(bundleWithoutHash as unknown as JsonValue));
  return {
    ...bundleWithoutHash,
    contentHash
  };
